...
REM
REM Generated by Vivado on Sun Jan 18 21:21:18 +0530 2026
...
echo "xvlog --incr --relax -prj tb_fp_divider_vlog.prj"
call xvlog  --incr --relax -prj tb_fp_divider_vlog.prj -log xvlog.log
